...
void QPSolver::setup_pointers(void) {
  ...
  vars.x_14 = work.x + 92;
  vars.x_15 = work.x + 96;
  vars.x_16 = work.x + 100;
  vars.x_17 = work.x + 104;
  vars.x_18 = work.x + 108;
  vars.x_19 = work.x + 112;
  vars.x_20 = work.x + 116;
  vars.x_21 = work.x + 120;
  vars.x_22 = work.x + 124;
  vars.x_23 = work.x + 128;
  vars.x_24 = work.x + 132;
  vars.x_25 = work.x + 136;
  vars.x_26 = work.x + 140;
  vars.x_27 = work.x + 144;
  vars.x_28 = work.x + 148;
  vars.x_29 = work.x + 152;
  vars.x_30 = work.x + 156;
  vars.x_31 = work.x + 160;
  vars.x_32 = work.x + 164;
  vars.x_33 = work.x + 168;
  vars.x_34 = work.x + 172;
  vars.x_35 = work.x + 176;
  vars.x_36 = work.x + 180;
  vars.x_37 = work.x + 184;
  vars.x_38 = work.x + 188;
  vars.x_39 = work.x + 192;
...
double QPSolver::eval_objv(void) {
  ...
  objv += work.quad_600568381440[0] + work.quad_898851794944[0] + work.quad_88433618944[0] + work.quad_240204779520[0] + work.quad_635618762752[0] +
          work.quad_732753989632[0] + work.quad_427523055616[0] + work.quad_976046530560[0] + work.quad_688550678528[0] + work.quad_304816418816[0] +
          work.quad_819339411456[0] + work.quad_101800079360[0] + work.quad_976903761920[0] + work.quad_141299838976[0] + work.quad_343404097536[0] +
          work.quad_815806124032[0] + work.quad_997002137600[0] + work.quad_141630619648[0] + work.quad_835263414272[0] + work.quad_962643562496[0] +
          work.quad_928463360000[0] + work.quad_380101586944[0] + work.quad_150659375104[0] + work.quad_392524365824[0] + work.quad_653656117248[0] +
          work.quad_70101270528[0] + work.quad_514920816640[0] + work.quad_674593345536[0] + work.quad_563078742016[0] + work.quad_758829424640[0] +
          work.quad_779426672640[0] + work.quad_59167404032[0] + work.quad_532283006976[0] + work.quad_792751730688[0] + work.quad_677500567552[0] +
          work.quad_848330452992[0] + work.quad_31841603584[0] + work.quad_193524883456[0] + work.quad_637564002304[0] + work.quad_646561718272[0];
  return objv;
}
...
long QPSolver::solve(void) {
  ...
  for (iter = 0; iter < settings.max_iters; iter++) {
    ...
    if (settings.verbose) {
      ...
      printf("%3d   %10.3e  %9.2e  %9.2e  %9.2e  % 6.4f\n", iter + 1, work.optval, work.gap, sqrt(work.eq_resid_squared), sqrt(work.ineq_resid_squared), alpha);
    }
#endif
